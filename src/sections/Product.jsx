...
function Product() {
    ...
    <section>
      <div className="container-wrapper">
        <div className="text-center">
          <Title className="text-white text-xl">OUR GOAL'S SIMPLE: UNLEASH EPIC GAINS</Title>
        </div>
  ...
  <div className=" flex justify-evenly flex-col sm:flex-row gap-8 items-center border-2 border-[#8ff852] rounded-xl bg-[#000000cc] py-4 px-2">
    ...
    <div>
      <p className="bg-[#000] text-white border-2 p-2 border-[#8ff852] my-2">100 Holders: 3X gains</p>
      <p className="bg-[#000] text-white border-2 p-2 border-[#8ff852] my-2">
